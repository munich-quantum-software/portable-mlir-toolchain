...
- ⬆️ Update default mold version to 2.42.1 ([#97]) ([**@denialhaag**])

### Removed

- 🔥 Remove Windows Debug builds ([#93]) ([**@denialhaag**])

## [2026.08.31]

### Distribution

- LLVM tag: `llvmorg-23.1.0`
- zstd version: `1.5.7`
- mold version: `2.42.0`
...
- 🛠️ Build LLVM and MLIR without runtime type information (RTTI) ([#74])
  ([**@burgholzer**])
...
- ⬆️ Update default mold version to 2.41.0 ([#40]) ([**@denialhaag**])

## [2026.03.29]

### Distribution

- LLVM tag: `llvmorg-22.1.2`
- zstd version: `1.5.7`
- mold version: `2.40.4`
...
- 🐧 Link Linux binaries with the `mold` linker ([#30]) ([**@burgholzer**])
- 🍎 Link with Apple's system linker on macOS ([#30]) ([**@burgholzer**])
- 🏁 Link with LLVM's `lld` linker on Windows ([#30]) ([**@burgholzer**])
- ♻️ Modularize the build scripts ([#30]) ([**@burgholzer**])
...
[#40]: https://github.com/munich-quantum-software/portable-mlir-toolchain/pull/40
