...
- `scripts/toolchain/macos/build-zstd.sh`, `scripts/toolchain/macos/build-mold.sh`, and `scripts/toolchain/macos/build-mlir.sh` for macOS, and
- `scripts/toolchain/windows/build-zstd.ps1`, `scripts/toolchain/windows/build-mold.ps1`, and `scripts/toolchain/windows/build-mlir.ps1` for Windows.
