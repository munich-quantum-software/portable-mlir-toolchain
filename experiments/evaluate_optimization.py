...
parser.add_argument("--core", type=Path, help="Pinned MQT Core source checkout; required for measurement")
...
project = args.core.resolve() if args.core else None
if not args.analyze and (project is None or not (project / "test/release/benchmark_optimization.py").is_file()):
    parser.error("--core must contain the Core release benchmarks")
